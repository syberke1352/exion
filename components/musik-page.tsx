...
export default function MusikPage() {
  const members = [
    { name: "Andi Mustofa", role: "Ketua", avatar: "/male-student-avatar.png", instrument: "Gitar", class: "XI IPA 1" },
    {
      name: "Sari Melodi",
      role: "Wakil Ketua",
    ...
    { name: "Doni Ritme", role: "Anggota", avatar: "/male-student-avatar.png", instrument: "Drum", class: "XI IPA 3" },
    {
      name: "Lisa Akord",
      role: "Anggota",
      avatar: "/female-student-avatar.png",
  ...
  const activities = [
    ...
    },
    {
      ...
      date: "2024-01-05",
      image: "/music-recording-studio.png",
    ...
    },
    {
      ...
      date: "2024-01-01",
      image: "/traditional-music-workshop.png",
