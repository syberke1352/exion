...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-blue-800 text-gray-800 relative overflow-hidden">
      ...
      <div className="relative container-responsive py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="space-y-6 sm:col-span-2 lg:col-span-1">
            <div>
              <h3 className="font-heading font-bold text-2xl mb-4 text-gray-900">SMK TI BAZMA</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-900 font-medium">Alamat Sekolah</p>
                  <p className="text-gray-600 text-sm">Jl. Raya Cikampak Cicadas, RT.1/RW.1, Cicadas, Kec. Ciampea, Kabupaten Bogor, Jawa Barat 16620</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">+62 811-1144-339</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">info@bazma.sch.id</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h4 className="font-heading font-semibold text-lg mb-6 text-gray-900">Navigasi Cepat</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.section}>
                  <button
                    onClick={() => onNavigate(link.section)}
                    className="text-gray-600 hover:text-black hover:translate-x-2 transition-all duration-300 text-left"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          <div>
            <h4 className="font-heading font-semibold text-lg mb-6 text-gray-900">Ekstrakurikuler</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="font-heading font-semibold text-lg mb-6 text-gray-900">Ikuti Kami</h4>
            ...
            <Card className="bg-gray-50 border border-gray-200 shadow-sm">
              <CardContent className="p-4">
                <h5 className="font-semibold text-gray-900 mb-2">Newsletter</h5>
                <p className="text-gray-600 text-sm mb-3">Dapatkan update terbaru tentang kegiatan ekstrakurikuler</p>
                <div className="flex gap-2">
                  <input
                    type="email"
                    placeholder="Email Anda"
                    className="flex-1 px-3 py-2 bg-white border border-gray-300 rounded-md text-gray-800 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  />
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <p className="text-gray-600 text-sm">
                © {currentYear} SMK TI BAZMA. Seluruh hak cipta dilindungi undang-undang.
              </p>
              <p className="text-gray-500 text-xs mt-1">Dikembangkan dengan ❤️ untuk kemajuan pendidikan Indonesia</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <Button onClick={scrollToTop} size="sm" className="bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-700">
